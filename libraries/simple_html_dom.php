 ...
 * print_r($articles);
 * ====================================================================================================
 * Website: http://simplehtmldom.sourceforge.net/
...
class simple_html_dom
{
    ...
    {
        return @simple_html_dom_parser::load_str("<$name>$value</$name>")->first_child();
    }

    function createTextNode($value)
    {
        return @end(simple_html_dom_parser::load_str($value)->nodes);
    }
