...
class CMS
{
    ...
    const fundamental_constants = [
        'SIS_FOLDERNAME', // => string(3) "new"
        'SIS_NAME', // => string(7) "Sistema"
        'SIS_NAME_FULL', // => string(16) "Sistema Auxiliar"
        'SIS_ABREV', // => string(3) "SIS"
        'SIS_EMAIL', // => string(15) "contato@sis.com"
        'SIS_EMAIL_ADMIN', // => string(13) "admin@sis.com"
        'SIS_URL', // => string(16) "http: //l.sis.com"
        'SIS_VIRTUAL_HOST', // => bool(false)
        'SIS_ITERACTION_ID', // => string(24) "20200324_170937_0.239302"
        'SIS_PATH', // => string(32) "C:\xampp\htdocs\manguto.com\new\"
        'SIS_HTML_PATH', // => string(0) ""
        'SIS_VENDOR_MANGUTO_PATH', // => string(47) "C:\xampp\htdocs\manguto.com\new\vendor\manguto\"
        'SIS_VENDOR_MANGUTO_LIB_NAME', // => string(4) "cms5"
        'SIS_VENDOR_MANGUTO_REPOSITORY_PATH', // => string(52) "C:\xampp\htdocs\manguto.com\new\vendor\manguto\cms5\"
        'SIS_LOG_PATH' // => string(4) "log\"
    ];
