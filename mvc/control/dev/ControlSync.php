...
use manguto\cms5\mvc\view\dev\ViewSync;


class ControlSync extends ControlDev
{
    ...
    const diretorioOuArquivo_criticos = [
        ...
        // ============================================================================= control
        'sis/control/admin/ControlZzz.php',
        'sis/control/site/ControlZzz.php',        
        'sis/control/crud/ControlZzz.php',
        // ============================================================================= model
        'sis/model/Zzz.php',
        // ============================================================================= lib
        // ============================================================================= view        
        'sis/view/admin/ViewZzz.php',
        'sis/view/site/ViewZzz.php',         
        'sis/view/crud/ViewZzz.php',
        // ============================================================================= tpl
        'sis/tpl/admin/zzz.html',
        'sis/tpl/site/zzz.html',
        'sis/tpl/crud/zzz.html',
        'sis/tpl/crud/zzz_edit.html',
        'sis/tpl/crud/zzz_view.html' 
    ];
    ...
    const diretorioOuArquivo_implementacoes = [
        ...
        'functions.php',
        // ============================================================================= control
        'sis/control/admin/ControlHome.php',
        'sis/control/site/ControlHome.php',
        // ============================================================================= model
        // ============================================================================= lib
        // ============================================================================= view        
        // ============================================================================= tpl
        ...
        'sis/tpl/site/home.html',
        'sis/tpl/admin/_menu.html',
        'sis/tpl/admin/home.html'        
    ];
    ...
    static function RunRouteAnalisys($app)
    {
        ...
        $app->get('/dev/sync/go', function () {
            self::PrivativeDevZone();
            ControlSync::get_dev_sync_go();
        });

        $app->post('/dev/sync/analyse', function () {
            self::PrivativeDevZone();
            ControlSync::get_dev_sync_analyse();
        });

        $app->post('/dev/sync/go', function () {
            self::PrivativeDevZone();
            ControlSync::get_dev_sync_go_save();
        });
    }
